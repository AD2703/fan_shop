...
orderitem1 = OrderItem.create(size: "L", quantity: 5, order: order1, campaign: campaignproduct1.campaign, product: campaignproduct1.product, value: 250.45)
orderitem2 = OrderItem.create(size: "S", quantity: 1, order: order1, campaign: campaignproduct2.campaign, product: campaignproduct2.product, value: 50.34)
orderitem3 = OrderItem.create(size: "M", quantity: 4, order: order1, campaign: campaignproduct3.campaign, product: campaignproduct3.product, value: 244.3)
orderitem4 = OrderItem.create(size: "L", quantity: 3, order: order1, campaign: campaignproduct4.campaign, product: campaignproduct4.product, value: 130)
orderitem5 = OrderItem.create(size: "S", quantity: 1, order: order2, campaign: campaignproduct5.campaign, product: campaignproduct5.product, value: 246.45)
orderitem6 = OrderItem.create(size: "M", quantity: 3, order: order2, campaign: campaignproduct6.campaign, product: campaignproduct6.product, value: 32.45)
orderitem7 = OrderItem.create(size: "L", quantity: 2, order: order2, campaign: campaignproduct7.campaign, product: campaignproduct7.product, value: 235.12)
orderitem8 = OrderItem.create(size: "S", quantity: 8, order: order2, campaign: campaignproduct8.campaign, product: campaignproduct8.product, value: 135.34)
...
orderitem12 = OrderItem.create(size: "L", quantity: 3, order: order4, campaign: campaignproduct4.campaign, product: campaignproduct4.product, value: 120)
orderitem13 = OrderItem.create(size: "S", quantity: 1, order: order4, campaign: campaignproduct5.campaign, product: campaignproduct5.product, value: 264)
orderitem14 = OrderItem.create(size: "M", quantity: 3, order: order4, campaign: campaignproduct9.campaign, product: campaignproduct9.product, value: 223.24)
orderitem15 = OrderItem.create(size: "L", quantity: 2, order: order4, campaign: campaignproduct7.campaign, product: campaignproduct7.product, value: 212.2)
orderitem16 = OrderItem.create(size: "S", quantity: 8, order: order5, campaign: campaignproduct8.campaign, product: campaignproduct8.product, value: 193.99)
orderitem17 = OrderItem.create(size: "L", quantity: 2, order: order5, campaign: campaignproduct7.campaign, product: campaignproduct7.product, value: 176.36)
orderitem18 = OrderItem.create(size: "S", quantity: 8, order: order5, campaign: campaignproduct10.campaign, product: campaignproduct10.product, value: 25)
...
orderitem22 = OrderItem.create(size: "L", quantity: 5, order: order7, campaign: campaignproduct9.campaign, product: campaignproduct9.product, value: 112.32)
orderitem23 = OrderItem.create(size: "S", quantity: 1, order: order7, campaign: campaignproduct10.campaign, product: campaignproduct10.product, value: 110.10)
orderitem24 = OrderItem.create(size: "M", quantity: 4, order: order7, campaign: campaignproduct3.campaign, product: campaignproduct3.product, value: 45.78)
...
orderitem29 = OrderItem.create(size: "S", quantity: 8, order: order9, campaign: campaignproduct8.campaign, product: campaignproduct8.product, value: 193.99)
orderitem30 = OrderItem.create(size: "L", quantity: 2, order: order9, campaign: campaignproduct7.campaign, product: campaignproduct7.product, value: 176.36)
orderitem31 = OrderItem.create(size: "S", quantity: 8, order: order9, campaign: campaignproduct10.campaign, product: campaignproduct10.product, value: 25)
